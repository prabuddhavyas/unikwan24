(function (factory) {
  ...
  Plugin.prototype = {
    ...
    _generateMarkup: function () {
      ...
      this.selectedFlagInner = $("<div>", { class: "iti-flag" }).appendTo(
        selectedFlag
      );
      if (this.options.separateDialCode) {
    ...
    _loadAutoCountry: function () {
      var that = this;
      var cookieAutoCountry = window.Cookies
        ? Cookies.get("itiAutoCountry")
        : "";
    ...
    _initKeyListeners: function () {
      ...
      this.telInput.on(
        "cut" + this.ns + " paste" + this.ns + " keyup" + this.ns,
        function () {
          setTimeout(function () {
            that._updateFlagFromNumber(that.telInput.val());
          });
    ...
    _getFullNumber: function () {
      var prefix = this.options.separateDialCode
        ? "+" + this.selectedCountryData.dialCode
        : "";
