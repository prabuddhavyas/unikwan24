<?php
  ...
  if(isset($postData['articlebrochureEmail'])) {
    $adminEmail = 'no-reply@unikwan.com';
    $clientAdminEmail = 'no-reply@unikwan.com';
    $email = $postData['articlebrochureEmail'];
    ...
    if($mail) {
      $from = $adminEmail;
      $to = $clientAdminEmail;
      $subject = "Brochure Downloaded by $email";
      $message = "Brochure Downloaded Details:<br/><br/> Email Id: $email";
